...
router.post('/', async (req, res) => {
  try {
    ...
    res.json({
      ...
      forecastRisk: result.forecastRisk,
      trustScore: result.trustScore,
      premium: result.premium,
      rawPremium: result.rawPremium,
      basePremium: result.basePremium,
      riskFactorAmount: result.riskFactorAmount,
      forecastRiskAmount: result.forecastRiskAmount,
      trustDiscount: result.trustDiscount,
      coverage: result.coverage,
      rawCoverage: result.rawCoverage,
      coverageBounds: result.coverageBounds,
      riskLevel: result.riskLevel,
      explanation: result.explanation,
      pricingFormula: result.pricingFormula,
      coverageFormula: result.coverageFormula,
